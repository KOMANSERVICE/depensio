...
---
# TACHE ACTUELLE
## Issue a analyser: #494 - US-HIS-002 : Filtrer les ventes par statut

### Description de l'issue:
<html>
<body>
<!--StartFragment--><h4 class="text-text-100 mt-2 -mb-1 text-base font-bold">US-HIS-002 : Filtrer les ventes par statut</h4>
<blockquote class="ml-2 border-l-4 border-border-300/10 pl-4 text-text-300">
<p class="font-claude-response-body break-words whitespace-normal leading-[1.7]"><strong>En tant que</strong> utilisateur<br>
<strong>Je veux</strong> filtrer la liste des ventes par statut<br>
<strong>Afin de</strong> voir uniquement les ventes valid├®es ou annul├®es</p>
</blockquote>
<p class="font-claude-response-body break-words whitespace-normal leading-[1.7]"><strong>Crit├¿res d'acceptation</strong></p>
<div class="overflow-x-auto w-full px-2 mb-6">
ID | Crit├¿re
-- | --
AC-1 | Nouveau param├¿tre status sur GET /sale/{boutiqueId}
AC-2 | Valeurs accept├®es : validated, cancelled, all
AC-3 | Par d├®faut : all (r├®trocompatibilit├®)
