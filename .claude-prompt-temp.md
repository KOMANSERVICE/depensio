...
---
# TACHE ACTUELLE
## Issue a analyser: #301 - Modification de magasin

### Description de l'issue:
En tant que utilisateur, je veux pouvoir selectionn├® un magazin, afin de le modifier

reccuperer depuis le micro service

Endpoint de selection : /magasin/{BoutiqueId:guid}/{id:guid} Get 
Response: 
succes : {
  "data": {
    "stockLocation": {
  ...
  "message": "string",
  "statusCode": 0,
  "timestamp": "2025-12-08T03:44:20.025Z",
  "success": true
}
...
Endpoint de modification : /magasin/{BoutiqueId}/{StockLocationId} Patch
Body {
  "stockLocation": {
    "name": "string",
    "address": "string"
...
Success {
  ...
  "message": "string",
  "statusCode": 0,
  "timestamp": "2025-12-08T03:44:20.029Z",
  "success": true
}
...
select le nom et l'adresse sont modificable
