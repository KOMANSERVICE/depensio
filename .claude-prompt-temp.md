...
---
# TACHE ACTUELLE
## Issue a analyser: #515 - BUG: ACHAT VALIDE #510

### Description de l'issue:
Annule la modification [BUG: ACHAT VALIDE](https://github.com/KOMANSERVICE/depensio/pull/510/files#top)
#510  c'est du n'import quoi.


L'ecran impact├® est la liste des produits sur l'ecran de vente et l'ecran de produit.

Sur l'ecran de "Gestion des produits" la valeur de stock pour automatique doit avoir uniquement les achats Approved.
pareil pour la caisse
