...
public class CreatePurchaseCommandValidator : AbstractValidator<CreatePurchaseCommand>
{
    ...
    {
        RuleFor(x => x.Purchase).NotNull().NotEmpty().WithMessage("Purchase is required");
        RuleFor(x => x.Purchase.Title).NotNull().NotEmpty().WithMessage("Title is required");
        ...
        RuleFor(x => x.Purchase.SupplierName).NotNull().NotEmpty().WithMessage("SupplierName is required");
